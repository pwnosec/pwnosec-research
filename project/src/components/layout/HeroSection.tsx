      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Bergabunglah dengan komunitas peneliti keamanan elit kami dan
            berkontribusi untuk membuat dunia digital lebih aman. Kami
            menggabungkan penelitian mutakhir dengan solusi praktis untuk
            melawan ancaman siber yang berkembang.
          </p>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-cyan-500 mb-2">68+</div>
              <div className="text-gray-400">Security Research</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-cyan-500 mb-2">300+</div>
              <div className="text-gray-400">Published Reports</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-cyan-500 mb-2">50M+</div>
              <div className="text-gray-400">Threat Detected</div>
            </div>
            <div className="text-center">
